...
public class Employee {
   ...
   public Employee() {}
	...
	public String toString() {
		return "Member [eId=" + eId + ", dId=" + dId + ", rId=" + rId + ", ePwd=" + ePwd + ", eName=" + eName + ", email="
				+ email + ", phone=" + phone + ", address=" + address + ", salary=" + salary + ", join_date=" + join_date
				+ ", leave_date=" + leave_date + ", status=" + status + ", holiday=" + holiday + ", eBirth=" + eBirth + "]";
	}
