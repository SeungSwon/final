            				...
            				<input type="hidden" value="${ employee.eId }" name="eId">
                                <table>
                                      <tr class="mo2">
                                          ...
                                          <td><input type="text" name="sName" value="${ ed1.sName }"></td>
                                      </tr>
                                      <tr class="mo2">
                                          <td class="mo1">학교유형</td>
                                          <td><input type="text" name="sType" value="${ ed1.sType }"></td>
                                      </tr>
                                      <tr class="mo2">
                                          <td class="mo1">입학일</td>
                                          <td><input type="text" name="admissonDate" value="${ ed1.admissonDate }"></td>
                                      </tr>
                                      <tr class="mo2">
                                          <td class="mo1">졸업일</td>
                                          <td><input type="text" name="graduationDay" value="${ ed1.graduationDay }"></td>
                                      </tr>
                                  </table>
