...
<jsp:include page="../common/menubar.jsp"/>
	...
	<input type="hidden" name="aName" value="기안서">
		<div class="content1">
			<div id="buttongroup">
							...
							<tbody>
								<tr>
									<td
										...
										colspan="2"
										class="dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">기안서</td>
								</tr>
								<tr>
									<td
							...
							<tbody>
								<tr>
									...
									<td
										...
										<input class="ipt_editor" type="date" name="effectiveDate"><br>
									</td>
								</tr>
								<tr>
									<td
									...
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 18px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<input class="ipt_editor" size="80" type="text" name="dTitle"><br>
									</td>
								</tr>
								<tr>
									<td
								...
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 18px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
										colspan="2">
										<textarea rows="14" cols="130" name="dContent"></textarea><br></td>
								</tr>
							</tbody>
						</table>
					</span>
