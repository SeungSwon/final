...
<jsp:include page="../common/menubar.jsp"/>
	...
	<input type="hidden" name="aName" value="시말서">
		<div class="content1">
			<div id="buttongroup">
							...
							<tbody>
								<tr>
									<td
										...
										colspan="2"
										class="dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">시말서</td>
								</tr>
								<tr>
									<td
							...
							<tbody>
								<tr>
									...
									<td
										...
										<input class="ipt_editor ipt_editor_date" size="40px" type="text" name="iTitle"><br></td>
								</tr>
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: top;"
										colspan="2"><textarea rows="5" cols="80" class="ipt_editor" type="text" name="iContent" ></textarea><br></td>
								</tr>
							</tbody>
						</table> <br>
					</span>
