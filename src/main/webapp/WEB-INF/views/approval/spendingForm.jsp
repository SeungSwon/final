...
<jsp:include page="../common/menubar.jsp"/>
	...
	<input type="hidden" name="aName" value="지출 결의서">
		<div class="content1">
			<div id="buttongroup">
			...
			<fmt:formatDate value="${now}" pattern="yyyy-MM-dd" var="today" />
					...
					<span
							...
							<tbody>
								<tr>
									<td
										...
										colspan="2"
										class="dext_table_border_t dext_table_border_r dext_table_border_b dext_table_border_l">지출 결의서</td>
								</tr>
								<tr>
									<td
						...
						<table
							style="width: 100%; border: 2px solid rgb(0, 0, 0); font-family: malgun gothic, dotum, arial, tahoma; margin-top: 10px; border-collapse: collapse;">
							<colgroup>
								<col width="130">
								<col width="260">
								<col width="260">
							...
							<tbody>
								<tr>
									<td
										style="background: rgb(221, 221, 221); padding: 5px; border: 1px solid black; height: 18px; text-align: center; color: black; font-size: 12px; font-weight: bold; vertical-align: top;">

										제목</td>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border-right: 1px solid black; border-bottom: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
										colspan="4">
										<input class="ipt_editor" size="80px" type="text" name="sTitle"><br>
									</td>
								</tr>
								<tr>
									<td
										style="background: rgb(221, 221, 221); padding: 5px; border-top: 2px solid black; border-right: 1px solid black; border-bottom: 1px solid black; height: 24px; text-align: center; color: black; font-size: 12px; font-weight: bold; vertical-align: top;"
										class="dext_table_border_l">거&nbsp;&nbsp;래&nbsp;&nbsp;처</td>
									<td
										style="background: rgb(221, 221, 221); padding: 5px; border-top: 2px solid black; border-right: 1px solid black; border-bottom: 1px solid black; height: 24px; text-align: center; color: black; font-size: 12px; font-weight: bold; vertical-align: top;"
										class="dext_table_border_r dext_table_border_l">

										지출일자</td>
									<td
										style="background: rgb(221, 221, 221); padding: 5px; border-top: 2px solid black; border-right: 1px solid black; border-bottom: 1px solid black; height: 24px; text-align: center; color: black; font-size: 12px; font-weight: bold; vertical-align: top;"
										colspan="2" class="dext_table_border_l">사용내역 및 용도</td>
									<td
										style="background: rgb(221, 221, 221); padding: 5px; border-top: 2px solid black; border-bottom: 1px solid black; height: 24px; text-align: center; color: black; font-size: 12px; font-weight: bold; vertical-align: top;"
										class="dext_table_border_r dext_table_border_l">
								...
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border-right: 1px solid black; border-bottom: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
										class="dext_table_border_t dext_table_border_l">
										<input class="ipt_editor" type="text" name="sAccount"><br>
									</td>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border-right: 1px solid black; border-bottom: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
										class="dext_table_border_t dext_table_border_l">
										<input class="ipt_editor" type="date" name="sDate"><br>
									</td>
									<td
										style="text-align: left; padding: 5px; border-bottom: 1px solid black; border-right: 1px solid black; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle; background: rgb(255, 255, 255);"
										colspan="2" class="dext_table_border_t dext_table_border_r dext_table_border_l">
										<input class="ipt_editor ipt_editor_currency" size="40px" type="text" name="sReason"> <br>
									</td>
									<td
										style="text-align: left; padding: 5px; border-bottom: 1px solid black; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle; background: rgb(255, 255, 255);"
										class="dext_table_border_t dext_table_border_r dext_table_border_l">
										<input class="ipt_editor ipt_editor_currency" type="text" name="sExtend"> <br>
									</td>
								</tr>
								<tr>
									<td
								...
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border-right: 1px solid black; border-bottom: 2px solid black; text-align: center; color: rgb(0, 0, 0); font-size: 12px; font-weight: bold; vertical-align: middle;"
										colspan="4" class="dext_table_border_t dext_table_border_l">

										총 지출 합계</td>
									<td
										style="text-align: left; padding: 5px; border-bottom: 2px solid black; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle; background: rgb(242, 220, 219);"
										class="dext_table_border_t dext_table_border_r dext_table_border_l">
											<input class="ipt_editor ipt_editor_currency" type="text" name="sAll"><br>
									</td>
								</tr>
							</tbody>
						</table> <br>
