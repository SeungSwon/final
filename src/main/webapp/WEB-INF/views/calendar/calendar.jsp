...
<body>
	...
	<div class="section"><br>
        <div class="aside">
            ...
            <button id="selectedMenu" onclick="location.href='calview.do'"><img class="icons" src="resources/images/common/calendar.png"><br>일정</button>
        ...
        <div class="section1">
            <div class="menubar">
                <button id="selected">전체 캘린더</button>
